...
if (strlen($_SESSION['id'] == 0)) {
    ...
    ?> 
                                    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                        ...
                                        <div class="rrow">
                                            <div class="col-md-12">
                                                <div class="container-fluid ccontainer-fullw bbg-white">
                                                    <div class="rrow">
                                                        <div class="col-md-12">
                                                                    ...
                                                                    <div class="panel panel-wwhite">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <?php include_once('horloge-heure.php'); ?>  
                                                                                <div style="color:red ; font-size: 120px ; text-align: center;" id="response"></div>
                                                                            ...
                                                                            <?php include_once('horloge-sb.php'); ?>  
                                                                                <div style="color:orange ; font-size: 60px ; text-align: center" id="response-sb"></div>
                                                                            <?php include_once('horloge-ante.php'); ?>  
                                                                                <div style="color:blue ; font-size: 30px ; text-align: center" id="response-ante"></div>
                                                                            <?php include_once('horloge-pause.php'); ?> 
                                                                                <div style="color:brown ; font-size: 30px ; text-align: center" id="car-pause"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
