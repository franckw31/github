                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="panel panel-white">
                                                    <div class="panel-heading">
                                                        <?php $fiche = intval($_GET['id']); ?>
                                                        <a href="voir-individu-loisirs.php?id=<?php echo $fiche; ?>"><h3 class="panel-title" align="right">Loisirs</h3> </a>
                                                        <a href="voir-individu.php?id=<?php echo $fiche; ?>"><h3 class="panel-title" align="right">Compétences</h3> </a>
                                                    </div> 
