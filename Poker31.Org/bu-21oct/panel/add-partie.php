...
if(isset($_POST['submit']))
{
    ...
    $msg=mysqli_query($con,"insert into vol(codevol,date_depart,heure_depart,destination,nb_classa,commentaire,structure,buyin,rake,bounty,recave,ante,jetons,addon,nom_org) values('$codevol','$date_depart','$heure_depart','$destination','$nb_classa','$commentaire','$structure','$buyin','$rake','$bounty','$recave','$ante','$jetons','$addon','$nom_org')");
	
	
    
//$sql=mysqli_query($con,"insert into competences(nom) values('$doctorspecilization')");
$_SESSION['msg']="Partie added successfully !!";
}
//Code Deletion
if(isset($_GET['del']))
{
