...
if(isset($_POST['submit']))
	...
	header('location:http://poker31.org/panel/gestion-parties.php');exit;
	}
//Code Deletion
if(isset($_GET['del']))
	{
												...
												<div class="panel-body">
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															...
															<input type="text" name="doctorspecilization" class="form-control"  placeholder="Entrer la Competence">
														</div>												
														<div class="card-body">
															<table class="table table-bordered">
																<tr>
																	<th>Titre</th>
																	<td><input class="form-control" id="titre-activite" name="titre-activite" type="text" value="<?php echo $result['titre-activite'];?>" required /></td>
																</tr>
																<tr>
																	<th>Date</th>
																...
																<tr>
																	<th>Lieu</th>
																	<td><input class="form-control" id="ville" name="ville" type="text" value="<?php echo $result['ville'];?>"  required /></td>
																</tr>
																<tr>
																	<th>Adresse</th>
																...
																<tr>
																	<th>Organisateur</th>
																	<td><input class="form-control" id="id-membre" name="id-membre" type="text" value="<?php echo $result['id-membre'];?>" required / ></td>
																</tr>
																<tr>
																	<th>Nb Joueurs Max</th>
																	<td><input class="form-control" id="places" name="places" type="text" value="<?php echo $result['places'];?>"  ></td>
																</tr>
																<tr>
																	<th>Buyin</th>
