...
$sql=mysqli_query($con,"select id from joueurs where email='$email'");
...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into joueurs(fname,prenom,lname,email,password,contactno) values('$fname','$prenom','$lname','$email','$password','$contact')");
...
<input class="form-control" id="prenom" name="prenom" type="text" placeholder="Enter your pseudo" required />
<label for="inputFirstName">Pseudo</label>
</div>
</div>
<div class="col-md-6">
<div class="form-floating mb-3 mb-md-0">
...
<input class="form-control" id="email" name="email" type="email" placeholder="user@poker31.org" required />
<label for="inputEmail">Email address</label>
</div>
 

<div class="form-floating mb-3">
<input class="form-control" id="contact" name="contact" type="text" placeholder="06123456778" required />
