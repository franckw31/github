...
//     echo "<script>alert('Image has Invalid format. Only jpg / jpeg/ png /gif format allowed');</script>"
       echo "Image has Invalid format. Only jpg / jpeg/ png /gif format allowed";
    }
     else
    {
	 $aimg=$aimg.time().$extension;
     move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$aimg);
     $msg=mysqli_query($con,"update joueurs set fname='$fname',lname='$lname',contactno='$contact' , where id='$userid'");
     if($msg)
     {
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <!-- <th>Photo</th> -->
									...
									<!--   <td><a href="changeimage.php?id=<?php echo $result['userid'];?>" </a></td> -->
								   </tr> 
                                   <tr>
                                       <th>Last Name</th>
