            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
<?php
$query=mysqli_query($con,"select id from joueurs");
$totalusers=mysqli_num_rows($query);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Gestion des Joueurs 
                                        <span style="font-size:22px;"> <?php echo $totalusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="manage-users.php">Liste des joueurs</a>
...
<!--
<?php
$query1=mysqli_query($con,"select id from joueurs where date(posting_date)=CURRENT_DATE()-1");
...
<?php
$query2=mysqli_query($con,"select id from joueurs where date(posting_date)>=now() - INTERVAL 7 day");
...
-->
<?php
$query3=mysqli_query($con,"select id from vol where date(date_depart)>=now() - INTERVAL 30 day");
$last30daysregusers=mysqli_num_rows($query3);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Gestion des Parties
                                        <span style="font-size:22px;"> <?php echo $last30daysregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="manage-partie.php">Liste des Parties</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
