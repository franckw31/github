...
$ret=mysqli_query($con,"select * from competences  where id='$userid'");



 ?>
<table id="datatable" class=""table table-bordered" style="border-collapse: collapse; border-spacing: 5; width: 100%;">
  <tr align="center">
   <th colspan="8" >Compétences</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Intitulé</th>
