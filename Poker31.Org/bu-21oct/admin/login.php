...
$ret= mysqli_query($con,"SELECT id,fname FROM joueurs WHERE email='$useremail' and password='$dec_password'");
...
header("location:http://poker31.org/admin/welcome.php");
echo "<script type='text/javascript'>window.location.replace('http://www.poker31.org/admin/welcome.php');</script>";
}
else
{
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="signup.php">Need an account? Sign up!</a></div>
                                          <div class="small"><a href="index.php">Back to Home</a></div>
										    <div class="small"><a href="welcome.php">Edit</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
