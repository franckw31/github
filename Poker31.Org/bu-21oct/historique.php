...
<body style="background: url('fondpoker.jpg');background-repeat: no-repeat;">
	<div align="center">
	<?php 
	print'<h2 class="rougesurblanc">Historique des parties effectués :</h2>';
    $rq=mysqli_query($conn,"select * from vol where date_depart <> '0000-00-00' and datediff(date_depart,now())<=-1");
	print'<table border="1" class="tab"><tr><th>Code</th><th>Lieu</th><th>Nombre de Joueurs</th><th>premier</th><th>second</th><th>troisieme</th><th>quatrieme</th>';
                ...
                <div class="container">
                    <div class="owl-carousel owl-theme blog-post">
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="jaune">
                                <h3>-</h3>
                                <button class="btn btn-blog">Infos</button>
                                <span></span>
                            </div>
                        </div>
