...
?>
  ...
  <?php 
  //nbre classa réservées

  $codevol=test_input(@$_POST['codevol']);
       $sql2=mysqli_query($conn,"select count(*)as nbre from passager where choix_class='Reservee' and code_vol='$codevol' ");
 ...
 <?php 
  ...
  //$codevol=@$_POST['codevol'];
       $sql3=mysqli_query($conn,"select count(*)as nbre from passager where choix_class='option' and code_vol='$codevol' ");
  if($resul2=mysqli_fetch_assoc($sql3)){
   $nb2=$resul2['nbre'];
  }
  ?>
...
<body>
	...
	<?php 
	print'<h2>Liste des tournois :</h2>';
	...
	<th>Lieu</th><th>Nombre de places</th><th>Réservées</th><th>Code Tournoi</th></tr>';
...
//	         echo"<td>$prix_classeb</td>";
	   ...
	   print'</table>';
	?>
	<h2 align="center">Formulaire de réservation de partie</h2>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST">
	<table >
	<tr><td><b>Numéro d'ordre :</b></td></tr>
	<tr><td><input type="text" name="num"></td></tr>
<!--	<tr><td><b>Nom passager :</b></td></tr>
	<tr><td><input type="text" name="nom"></td></tr> -->
	<tr><td><b>Prénom du joueur :</b></td></tr>
...
<!--//	<tr><td><b>Sexe passager :</b></td></tr>
	...
	<tr><td><b>Choix de réservation :</b></td></tr>
	<tr><td><select name="ch_classe" id="ch_classe"  >
         <option  value="classe A">Inscription</option>
        <option  value="classe B">Option</option>
     </select></td></tr>
     <tr><td><b>Code Tournoi :</b></td></tr>
