...
<body>
    ...
    <!-- ----------------------------  Navigation ---------------------------------------------- -->
     ...
     <nav>
        <div class="flex-row">
            <div>
                <a href="index.php"><img src="./assets/Blog-post/logo.png" height="150" width="150" alt="post-1"></a>
...
<div align="center" class="site-background" data-aos="fade-up" data-aos-delay="100">
...
if ( (isset($_POST['submit']) && ($prenom<>"-Anonyme-")) or ((isset($_POST['submit'])&&(!empty($co))))   )
  ...
  $exe=mysqli_query($conn,"insert into passager (numpiece,nom,prenom,sexe,choix_class,code_vol,etat,ip,ipmod,ipsup,co,ds,highlander_Insc) values ('$nomb','$prenom','$prenom','','$place','$mat','Actif','$ip_add','$ip_add','$ip_add','$co','$ds','$Highlander_Insc') ");
 ...
 else
 {
   ...
   print "-$nomb-$nom-$prenom-$place-$mat-$nomb2-$ip_add-$co-$ds-$Highlander_Insc"; }
 }
 $place=@$_POST['ch_classe'];
...
<?php 
echo'<h1 align="center" class="rougesurblanc">Liste des Inscrits</h1>';	
$sql="select * from passager where code_vol='$mat' AND etat='Actif' order by numpiece";
$exe=mysqli_query($conn,$sql);
	print'<table border="3" class="tab"><tr><th>Inscrit</th><th>Pseudo</th><th>Inscription</th><th>Challenge</th><th>Nb Tentat.</th><th>Qualifié </th></tr>';
...
//	         echo"<td>$sexe</td>";
 ...
 <!-- </div> -->
	...
	<div align="center"> 
	 <table border= '0px' class= 'tab2' bgcolor= 'black'>
   ...
   $co="";
	  ...
	  //{
   @$mat=$_GET['Matricule'];
   echo'<h1 align="center" class="blanc">Partie '.$mat.'</h1>';
   ?>
<!--   <br> -->
   <!-- <tr> -->
   <!-- <th> -->
     <?php
  	 echo "<p align='center' class='rougesurblanc'>Nouvelle inscription :</p>";
    ?>
   <!-- </th> -->
   <!-- <th> -->
    <?php
...
//  	 echo "<p align='center' class='blanc'>Inscrits : $nomb3  Validés : $nomb4 Dispo : $disp</p>";
       echo "<h align='center' class='blanc'>Inscrits : $nomb3 </h>";
       echo "<h align='center' class='blanc'>Validés : $nomb4 </h>";
       echo "<h align='center' class='blanc'>Dispos : $disp </h>";	   
  ?>
    <br><br>
   <!-- </th> -->
   <!-- </tr> -->
...
//    echo "<h align='center' class='jaune'>Pseudo : <select name=prenom><option value='-Anonyme-'>Choisir ICI --></h>"; 
    ...
    echo "<align='center' class='rougesurblanc'>Pseudo : <select name=prenom><option value='-Anonyme-'>--> Liste des Pseudo IcI <--";
   ...
   <!-- <tr height='30px'></tr> -->
   <!-- <tr> -->
     <a><input class="com" type="text" name="co"  size="35" placeholder="Commentaire : ( Obligatoire si Anonyme !!!)"></a>
     <tr>
	 <th>
     <h1 align='left'><input type="submit" class="boutton_jaune" name="bmodif" title="Modifier" value="Modifier"></h1>
	 </th>
     <!-- <tr height='30px'></tr> -->
    <!-- </tr> -->
	<!--   <tr> -->
	<th>
          <h1 align='center' height='30px'><input type=Submit class="boutton_bleu" name="submit" title="Confirmer" value="Valider Création ici"></h1> 
	</th>
    <th>    
		<h1 align='right'><input type="submit" class="boutton_rouge" name="bsupp" title="Supprimer" value="OUT"></h1>
    </th>
	</tr>
	<!-- </tr> -->
    <!-- <tr height='30px'></tr> -->
