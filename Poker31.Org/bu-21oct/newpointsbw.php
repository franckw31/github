      ...
      //      if ( ((isset($_POST['bsupp']) && ($prenom<>"-Anonyme-")) or ( (isset($_POST['bsupp'])&&(!empty($co)))) ) &&  ($j == $prenom )   ){
           ...
           <?php 
            ...
            $exe=mysqli_query($conn,$sql);
	           print'<table border="5" class="tab3"><tr><th>Ordre</th><th>Prénom ou Pseudo</th><th>Classement<th>Recave<th>Gains</th></tr>';
            ...
            //nbrepassagersact
             ...
             <tr>
              <th>
               <?php
                $joueurs = mysqli_query($conn, "SELECT id,prenom,clas,recave,gain FROM passager WHERE code_vol='$mat' AND etat='Actif' order by id");
