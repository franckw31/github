...
$dbss=array();
$dbss['host']='db5011435974.hosting-data.io';      // Database host (in most cases 'localhost', on Windows systems - use '127.0.0.1' instead of 'localhost' to avoid a php/ipv6 bug)
$dbss['user']='dbu5476619';      // Database user
$dbss['pass']='Kookies7*';      // Database password
$dbss['name']='dbs9649121';      // Database name. Note that the installation script cannot create a database for you!
