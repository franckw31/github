...
<body>
   ...
   <br><br><br>  <br><br><br>
    ...
    $rq=mysqli_query($conn,"select * from vol where date_depart <> '0000-00-00' and datediff(date_depart,now())<=-1 and prix_classa>4 order by id DESC");
	print'<table border="1" class="tab" opacity="0,1" width="90%" margin-left= "10px"><tr><th>Code</th><th>Lieu</th><th>Participants</th><th>premier</th><th>second</th><th>troisieme</th><th>quatrieme</th><th>cinquieme</th><th>classement</th>';
